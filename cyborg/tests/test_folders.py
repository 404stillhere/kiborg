...
class TestFolders(unittest.TestCase):
    ...
    def test_string_items_default_on(self):
        ...
        self.assertEqual(folders.load()["folders"], [{"path": "M:/a", "on": True}, {"path": "M:/b", "on": True}])
    ...
    def test_toggle_preserves_order_and_flags(self):
        folders.save([{"path": "M:/a", "on": True}, {"path": "M:/b", "on": False}, {"path": "M:/c", "on": True}])
        self.assertEqual(
            folders.load()["folders"],
            [{"path": "M:/a", "on": True}, {"path": "M:/b", "on": False}, {"path": "M:/c", "on": True}],
        )
