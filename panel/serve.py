...
RUN_TIMEOUT = 600  # с (10 мин); с всегда-включённым оркестром отбор идёт ~3 мин (7 рецензентов
                   # × 6 идей по очереди) — таймаут только как страховка от настоящего висяка сети,
                   # НЕ как ограничение на нормальный прогон. Дольше 10 мин — точно зависло:
